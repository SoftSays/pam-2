...
var prefix = "$"
var adminprefix = "$" 
const developers = "620588587993399297","id"]
...
client.on("reachLimit", (limit)=> {
  let log = limit.guild.channels.find( channel => channel.name === "الرؤية-السرية");
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '582093431770185745').send(` **❤️ 🧡 💛 💚 💙 💜 مــرحـبـاً بــك فــي الـســيرفــر الــعــربــي ❤️ 🧡 💛 💚 💙 💜 **  `)
});
/////////
...
/////
client.login('NjIwNTg4NTg3OTkzMzk5Mjk3.XXZNPQ.kmy3usHYeG-L6GLuU5wQDwg86IQ');
